...
typedef struct _vptree {
    double *vp;
    double md; // The median distance of the vantage point to the other points.
    int idx; // Vantage point id in the original X Array.
    struct _vptree *inner;
    struct _vptree *outer;
} vptree;
